...
# # Access Tokens
# api_key = "1VaXCSGVExbT19nlQv8WmdHY4"
# api_secret = "fcgXoKN574lV6AzOGVfmfXgfltTqXTESJimTqddeb3Y3akQjIh"
...
# search_query = 'shanks -filter:retweets'

# # Get tweets from the API
# tweets = tw.Cursor(api.search, q=search_query, lang="es", since="2020-03-21", until="2020-03-26").items(6000)
# # tweets = tw.Cursor(api.search, q=search_query, lang="es", since="2022-08-15").items(6000)
...
# tweets_df.to_excel("fetched_tweets.xlsx")
